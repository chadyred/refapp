$(document).ready(function() {
  ...
  function ajouterEnvironnement($container) {
   ...
   // $prototype.append('<a href="#" class="InfoBulleEnv" title="Appuyer sur Ctrl pour sélectionner plusieurs champs" ><img src="bundles/melonrefapp/images/infobulle.png" alt="Infobulle" /></a>');	
